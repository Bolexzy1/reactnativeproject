...
import { Text, View, ScrollView, FlatList, Modal, Button, StyleSheet, PanResponder, Share} from 'react-native';
    ...
    const panResponder = PanResponder.create({
     ...
     onPanResponderEnd: (e, gestureState) => {
         ...
         if(recognizeDrag(gestureState)) {
             Alert.alert(
                 'Add Favorite',
                 'Are you sure you wish to add ' + campsite.name + 'tofavorite?',
                 [
                     {
                         text: 'Cancel',
                         style: 'cancel',
